...
* 线程池的原理，以及线程池的好处，拒绝策略等？

* 线程池是怎么创建的，参数了解吗，实现原理知道吗，知道为什么要使用阻塞队列而不使用队列吗
